...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="main/img/logo.png" width="108" height="125" alt=""></a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <!-- <li class="scroll"><a href="#contact">Lokasi</a></li> -->
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms" style="color: black;"> PELAYANAN SURAT KETERANGAN <br> DESA SINDANGKERTA </h2>
                <!-- <p class=" wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms" style="color: black;">Klik Login untuk request pembuatan surat keterangan online
        ...
        <img class="img-responsive wow fadeIn" src="main/images/cta2/pen.png" alt="align" data-wow-duration="300ms" data-wow-delay="300ms">
        </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInLeft">
                    <img class="img-responsive" src="main/img/attendance.png" width="250" height="300" alt="">
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Permohonan di setujui oleh kepala desa, kemudian staf akan mencetak surat sesuai request surat yang diajukan, pemohon mengambil surat yang sudah dicetak dan bertandatangan di Kantor Kuwu Desa Sindangkerta.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
    ...
    <!-- <section id="contact">
        <div>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.039974565474!2d108.28708631396799!3d-6.3888433953771715!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6eb9349a90cff7%3A0xced7c0b91642867c!2sBalai%20Desa%20Sindang%20Kerta!5e0!3m2!1sid!2sid!4v1638198898481!5m2!1sid!2sid" width="100%" height="650px" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" alt="lokasi kelurahan"></iframe>
        </div>
    </section> --> -->
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <?php echo date('Y'); ?> Kelompok 7. Credit by <a target="_blank" href="https://www.instagram.com/isaiasm.r/" title="Ikuti saya">Kelompok 7</a>
                </div>
                <div class="col-sm-6">
                    <ul class="social-icons">
                        <li><a href="https://www.instagram.com/isaiasm.r/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                        <li><a href="https://www.facebook.com/isaias.muhammad/" target="_blank"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="https://www.youtube.com/channel/UCpROXS2FwjVXpGnMCNCcJ9A" target="_blank"><i class="fa fa-youtube"></i></a></li>
                        <li><a href="https://github.com/isaias0412" target="_blank"><i class="fa fa-github"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
