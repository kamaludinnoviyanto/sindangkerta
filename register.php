...
<body>
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="main/img/logo4.png" width="108" height="155" alt="logo">
              </div>
              <h4>HALAMAN REGISTER</h4>
              <form method="POST" class="pt-3">
                <div class="form-group">
                  <input type="number" name="nik" class="form-control form-control-lg" placeholder="NIK" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="16" autocomplete="off" required autofocus>
                </div>
                <div class="form-group">
                  <input type="text" name="nama" class="form-control form-control-lg" placeholder="Nama Lengkap" required autofocus>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="text" name="kota" class="form-control form-control-lg" placeholder="Kota Lahir" autocomplete="off" required autofocus="Wajib Diisi">
                </div>

                <div class="form-group">
                  <input type="text" name="agama" class="form-control form-control-lg" placeholder="Agama" autocomplete="off" required autofocus="Wajib Diisi">
                </div>
                <div class="form-group">
                  <input type="text" name="alamat" class="form-control form-control-lg" placeholder="Alamat" autocomplete="off" required autofocus="Wajib Diisi">
                </div>

                <div class="form-group">
                  <input type="text" name="pekerjaan" class="form-control form-control-lg" placeholder="Pekerjaan" autocomplete="off" required autofocus="Wajib Diisi">
                </div>
            ...
            <div class="mt-3">
              <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="http://localhost/sindangkerta">BATAL</a>
            </div>
  ...
  if (isset($_POST['register'])) {
    ...
    if ($query_simpan == 1) {
      ...
      $kota = $_POST['kota'];
      $tgl = $_POST['tgl'];
      $ins = "INSERT INTO data_pemohon (nik,nama,jekel,agama,alamat,pekerjaan,tempat_lahir,tanggal_lahir) VALUES ('$nik','$nama','$jekel','$agama','$alamat','$pekerjaan','$kota','$tgl')";
