          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="main/img/logo3.png" width="150" height="54" alt="logo">
              </div>
              <h4>SISDEKA</h4>
              <h6 class="font-weight-light"></h6>
              <form method="POST" class="pt-3">
                <div class="form-group">
                  <input type="text" name="nik" class="form-control form-control-xs text-bold" placeholder="NIK Anda.." 
                  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "16" autocomplete="off" required autofocus>
                </div>
                <div class="form-group">
                ...
                <div class="mb-2">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="index.php"http://localhost/surat-keterangan-desa/">BATAL</a> 
                </div>
